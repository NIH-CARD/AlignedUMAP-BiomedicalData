...
def get_embedding(data, selected_feature_index, feature_group_name, data_dir, input_parameter={
    ...
    if os.path.exists ( data_dir / f"cache_data/{feature_group_name}/{input_parameter['id']}_umap_aligned.pickle"):
        print ("Embedding Exists:", data_dir / f"cache_data/{feature_group_name}/{input_parameter['id']}_umap_aligned.pickle")
        with open( data_dir / f"cache_data/{feature_group_name}/{input_parameter['id']}_umap_aligned.pickle", 'rb') as handle:
    ...
    with open( data_dir / f"cache_data/{feature_group_name}/{input_parameter['id']}_umap_aligned.pickle", 'wb') as handle:
